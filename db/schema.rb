...
ActiveRecord::Schema.define(version: 2017_04_20_210937) do
  ...
  create_table "employee_service_calls", id: :serial, force: :cascade do |t|
  ...
  create_table "service_calls", id: :serial, force: :cascade do |t|
  ...
  create_table "truck_service_calls", id: :serial, force: :cascade do |t|
    t.integer "truck_id"
    t.integer "service_call_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
